...
`grid_city` contains 1 km grid square codes for each municipality in Japan.
...
Use `convert_grid()` to coarsen the grid size of Grid Square Codes.
...
### Others
- `move_grid()` function can be used to calculate the grid square code in the east-west and north-south directions.
